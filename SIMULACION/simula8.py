		...
		for opt,arg in opts:
			if opt in ("-h","--help"):
				parser=argparse.ArgumentParser(description='''
					El objetivo, es generar un archivo en donde se calcula el ingreso de acuerdo a las ventas en el intervalo (v,V) donde <v> representa laventa mínima y <V> la venta máxima.
					El usuario podrá determinar la cantidad de días por simular, misma que se declara en la variable <d>; así entonces, esta cantidad deberá ser un entero no negativo.
					La variable <p> representa el precio de venta por unidad.
					''',epilog='''
					En caso de no declarar ningún valor para <p>, se tomará como valorpor default de $60/unidad; a su vez, la variable <d> de no señalarse,representará 30 días.
					'''
					)
